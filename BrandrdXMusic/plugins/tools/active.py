...
@app.on_message(filters.command(["activevc", "activevoice","vc"]) & OWNER_ID)
...
@app.on_message(filters.command(["activev", "activevideo","vvc"]) & OWNER_ID)
...
@app.on_message(filters.command(["ac","av"]) & OWNER_ID)
